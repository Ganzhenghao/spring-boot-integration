 ...
 * @Version 1.0
 */
public class ElasticSearchBasicUse_Doc_Query_TermMatch {
    public static void main(String[] args) {
        ...
        SearchRequest searchRequest = request.source(new SearchSourceBuilder()
                .query(QueryBuilders.termQuery("age", "28")));
